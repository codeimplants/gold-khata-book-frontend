...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
  <circle cx="24" cy="24" r="22" fill="#2196F3" stroke="#BBDEFB" stroke-width="2"/>
  <path fill="#fff" d="M17.1 22.1c1.5 3.1 4 5.5 7.1 7.1l2.4-2.4c.3-.3.7-.4 1-.2 1.2.4 2.5.6 3.9.6.6 0 1.1.5 1.1 1.1v3.9c0 .6-.5 1.1-1.1 1.1C20.8 33.3 13 25.5 13 16.1c0-.6.5-1.1 1.1-1.1h3.9c.6 0 1.1.5 1.1 1.1 0 1.4.2 2.7.6 3.9.1.4 0 .8-.2 1l-2.4 2.1z"/>
</svg>
`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill-rule="evenodd" clip-rule="evenodd">
  ...
  <path fill="#cfd8dc" d="M24,4C13,4,4,13,4,24c0,3.4,0.8,6.7,2.5,9.6L3.9,43c-0.1,0.3,0,0.7,0.3,1c0.2,0.2,0.4,0.3,0.7,0.3c0.1,0,0.2,0,0.3,0l9.7-2.5c2.8,1.5,6,2.2,9.2,2.2c11,0,20-9,20-20c0-5.3-2.1-10.4-5.8-14.1C34.4,6.1,29.4,4,24,4z"/>
